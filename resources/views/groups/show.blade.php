...
<x-modals.confirm-modal
    ...
    :message="'¿Estás seguro de que deseas eliminar el grupo <strong>' . $group->name . '</strong>? Esta acción no se puede deshacer.'"
    :action="route('groups.destroy', $group->group_id)"
    ...
    <div class="px-4 py-3 @container">
        <div class="flex overflow-hidden rounded-xl border border-[#dde1e3] bg-white">
            <table class="flex-1">
                <thead>
                    <tr class="bg-white">
                        <th class="table-1cf82bb8-808c-49ec-b05f-f76f630d80a4-column-120 px-4 py-3 text-left text-[#121416] w-[400px] text-sm font-medium leading-normal">Nombre</th>
                        <th class="table-1cf82bb8-808c-49ec-b05f-f76f630d80a4-column-240 px-4 py-3 text-left text-[#121416] w-[400px] text-sm font-medium leading-normal">Email</th>
                        <th class="table-1cf82bb8-808c-49ec-b05f-f76f630d80a4-column-360 px-4 py-3 text-left text-[#121416] w-[400px] text-sm font-medium leading-normal">
                            Teléfono
                        </th>
                    </tr>
                </thead>
